...
class EmployerAdsView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final adsState = ref.watch(employerAdsProvider);
    ...
    return adsState.when(
      ...
      data: (ads) {
        ...
        return RefreshIndicator(
          onRefresh: () async {
            await ref.read(employerAdsProvider.notifier).fetchEmployerAds();
          },
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return EmployerCard(ad: ads[index]);
            },
          ),
        );
      },
...
class EmployerCard extends StatelessWidget {
  final EmployerAdEntity ad;

  const EmployerCard({super.key, required this.ad});
