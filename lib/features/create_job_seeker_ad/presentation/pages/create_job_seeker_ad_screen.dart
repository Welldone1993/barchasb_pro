...
class JobSeekerAddJobScreen extends ConsumerStatefulWidget {
  const JobSeekerAddJobScreen({super.key});

  @override
  ConsumerState<JobSeekerAddJobScreen> createState() =>
      _JobSeekerAddJobScreenState();
}

class _JobSeekerAddJobScreenState extends ConsumerState<JobSeekerAddJobScreen> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(jobSeekerAdProvider);

    // گوش دادن به تغییرات استپ برای انیمیشن PageView
    ref.listen<JobSeekerAdState>(jobSeekerAdProvider, (previous, next) {
