  ...
  FaqTopic(
    ...
    questions: [
      ...
      FaqQuestion(
        ...
        answer:
            'با تکمیل پروفایل رزومه ساز، ثبت آگهی‌های مناقصه کامل و همچنین تعامل با پیشنهادات هوشمند در داشبورد می‌توانید امتیاز خود را ارتقا دهید.',
      ),
    ],
  ),
  FaqTopic(
    title: 'ثبت آگهی مناقصه',
    questions: [
      FaqQuestion(
